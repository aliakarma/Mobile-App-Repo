...
class _ApplicationsScreenState extends State<ApplicationsScreen> {
  ...
  void initState() {
    super.initState();
    _repository = widget._repository ?? LocalApplicationsRepository();
    _loadApplications();
  }
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    await _repository.insertApplication(newApplication);
  ...
  Future<ApplicationModel> _buildScoredApplication({
    ...
    final recommendationResult =
        ApplicationIntelligenceService.getRecommendationResult(
      fitScore: fitScore,
      readinessScore: readinessScore,
    ...
    return ApplicationModel(
      ...
      recommendation: recommendationResult.label,
    );
  }
  ...
  String _recommendationReasonForApplication(ApplicationModel application) {
    ...
    return ApplicationIntelligenceService.getRecommendationResult(
      ...
      body: _isLoading
          ...
          : _applications.isEmpty
              ? EmptyState(
                  ...
                  onPrimaryAction: _showAddApplicationDialog,
                  secondaryActionLabel: 'Refresh',
                  onSecondaryAction: _loadApplications,
                )
              : RefreshIndicator(
